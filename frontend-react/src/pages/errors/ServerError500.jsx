  ...
  return (
    ...
    >
      ...
      <div className="text-center position-relative px-3" style={{ zIndex: 2, maxWidth: '700px' }}>
        ...
        {/* Título */}
        <h2 className="h1 fw-bold mb-3 text-white">Error interno del servidor</h2>

        {/* Mensaje */}
        <p className="lead mb-5 text-white-50" style={{ fontSize: '1.2rem', lineHeight: '1.8' }}>
          Lo sentimos, ha ocurrido un error inesperado en nuestro servidor. Nuestro equipo ha sido notificado y estamos trabajando para solucionarlo.
        </p>
