  ...
  return (
    ...
    >
      ...
      <div className="text-center position-relative px-3" style={{ zIndex: 2, maxWidth: '700px' }}>
        ...
        {/* Título */}
        <h2 className="h1 fw-bold mb-3 text-white">Acceso denegado</h2>

        {/* Mensaje */}
        <p className="lead mb-5 text-white-50" style={{ fontSize: '1.2rem', lineHeight: '1.8' }}>
          No tienes permisos para acceder a esta página. Por favor, inicia sesión con una cuenta autorizada o contacta con el administrador.
        </p>
